...
exports.seed = async function(knex) {
  ...
  await knex('maintenance').insert([
    ...
    {task_title: 'Damon almost Broke Something', site_id: '3', start_date: '2025-03-05', end_date: '2025-03-09', condition_color: 'Green', approved_rejected: '', approver_comments: ''},
    {task_title: 'Renamed Again', site_id: '2', start_date: '2025-03-20', end_date: '2025-03-22', condition_color: 'Yellow', approved_rejected: '', approver_comments: ''}
  ]);
};
